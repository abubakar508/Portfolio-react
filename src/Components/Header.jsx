  ...
  return (
    <div>
      ...
      <div className=" p-2 pr-24  fixed w-full items-center justify-end flex z-40 backdrop-blur-sm  text-slate-100">
        ...
        <Link to='/Journey' className=" border p-2 rounded-md text-lg hover:bg-orange-500 "> Journey</Link>
        <Link to='/Blog' className=" border p-2 rounded-md text-lg hover:bg-orange-500 ">Blog</Link>
        </div>  
      </div>
    </div>
  );
